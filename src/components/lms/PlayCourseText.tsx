      ...
      <div className="container-fluid">
        <div className="row mt-3">
          <div className="order-1 order-md-0 col-md-8">
            <div className="card mb-3 bg-2 border-0">
              <div className="card-header bg-transparent">
                <p className="mb-0 fw-600 text-dark">
                  Why do you need market intelligence?
                </p>
              </div>
              <div className="card-body bg-transparent">
                pEnjoy instant access to our vast library of 5,121 premium
                products and all upcoming new releases with super-fast download
                speeds powered by Amazon S3. Yes, you read that right. Getting
                $127,035 in value means you're saving more than 99% on all
                products making it the sweetest deal for premium design assets
                around.
              </div>
            </div>
